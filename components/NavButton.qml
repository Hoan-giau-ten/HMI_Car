...
Window {
    ...
    FontLoader {
        ...
        source: "file:///C:/Users/ADMIN/Documents/QT/HMI_Car/font/MaterialSymbolsOutlined.ttf"
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Column {
                Layout.alignment: Qt.AlignVCenter
                Text { text: tempLeft + "°"; color: "#ffffff"; font.pixelSize: 32; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter }
            ...
            Column {
                Layout.alignment: Qt.AlignVCenter
                Text { text: tempRight + "°"; color: "#ffffff"; font.pixelSize: 32; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter }
